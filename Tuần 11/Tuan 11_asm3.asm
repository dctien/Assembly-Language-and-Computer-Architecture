...
.data
Message: .asciiz "Key scan code " #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   # MAIN Procedure #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.text 
main:
#---------------------------------------------------------
...
#-------------------------------------------------------
IntSR:
	addi $sp,$sp,4	# Save $ra because we may change it late 
	sw $ra,0($sp)
	addi $sp,$sp,4	# Save $at because we may change it late 
	sw $at,0($sp)
	addi $sp,$sp,4	# Save $sp because we may change it late 
	sw $v0,0($sp)
	addi $sp,$sp,4	# Save $a0 because we may change it late 
	sw $a0,0($sp)
	addi $sp,$sp,4	# Save $t1 because we may change it late 
	sw $t1,0($sp)
	addi $sp,$sp,4	# Save $t3 because we may change it late 
	sw $t3,0($sp)
#--------------------------------------------------------
# Processing
#--------------------------------------------------------
